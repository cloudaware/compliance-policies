...
This policy flags an *Azure Virtual Machine* as `INCOMPLIANT` if it is **running** in one of the following regions identified as less cost-efficient:
...
| `ukwest`,<br>`uksouth`,<br>`francecentral`,<br>`francesouth`,<br>`westeurope`,<br>`germanywestcentral`,<br>`germanynorth`,<br>`switzerlandnorth`,<br>`switzerlandwest`,<br>`italynorth`,<br>`polandcentral`,<br>`norwayeast`,<br>`norwaywest`,<br>`swedensouth`,<br>`spaincentral`| `swedencentral`, `northeurope`|
| `southindia`,<br>`westindia`                   | `centralindia`                                           |
| `australiasoutheast`                           | `australiacentral`, `australiacentral2`, `australiaeast` |
| `japaneast`,<br>`japanwest`,<br>`koreacentral` | `koreasouth`                                             |

If the *Azure Virtual Machine* is not **running**, it is marked as `INAPPLICABLE`.
