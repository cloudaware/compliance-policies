...
This policy flags an *Azure SQL Managed Instance* as `INCOMPLIANT` if it is **running** in one of the following regions identified as less cost-efficient:
...
| `ukwest`,<br>`uksouth`,<br>`francecentral`,<br>`francesouth`,<br>`westeurope`,<br>`germanywestcentral`,<br>`germanynorth`,<br>`switzerlandnorth`,<br>`switzerlandwest`,<br>`italynorth`,<br>`polandcentral`,<br>`norwayeast`,<br>`norwaywest`,<br>`swedensouth`,<br>`spaincentral`|`northeurope`|
| `southindia`                     | `centralindia`, `westindia`               |
| `japanwest`                      | `koreasouth`, `japaneast`, `koreacentral` |
