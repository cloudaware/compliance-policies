...
This policy flags an *Azure PostgreSQL Database* as `INCOMPLIANT` if it is **running** in one of the following regions identified as less cost-efficient:
...
| `australiacentral`,<br>`australiacentral2`     | `australiasoutheast`, `australiaeast`  |
