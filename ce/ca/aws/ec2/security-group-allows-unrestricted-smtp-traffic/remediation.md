...
1. Run the following command to remove or modify the unrestricted rule for SMTP
access:
...
3. Conduct tests to verify functionality of applications dependent on SMTP to ensure they are unaffected by the changes.
