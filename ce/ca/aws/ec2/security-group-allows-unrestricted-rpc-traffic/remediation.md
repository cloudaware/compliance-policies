...
1. Run the following command to remove or modify the unrestricted rule for RPC
access:
...
3. Test applications dependent on RPC to ensure they are unaffected by the changes.
