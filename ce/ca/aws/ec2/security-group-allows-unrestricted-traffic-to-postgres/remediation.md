...
1. Run the following command to remove or modify the unrestricted rule for PostgreSQL access:
...
3. Monitor PostgreSQL access to ensure it's unaffected by the changes.
