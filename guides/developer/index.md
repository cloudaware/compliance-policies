...
- `/types/types.json`: List of all types available in the organization (updates with any call to `repo-manager types import`)
...
- **Root directories**: Use predefined names with specific purposes:
  ...
  - `/schema`, `/tmp`, `/lists`: Follow exact naming for tooling compatibility
